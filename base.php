<?php
    ...
    // タイムゾーン設定_こういう関数_デフォルトが日本でない場合が多いので、時間を取得する場合は設定すると◯
...
<body>
    ...
    <section>
        ...
        <article><!-- article：投稿やコメントを複数並べる時に使う -->
            <div class="info">

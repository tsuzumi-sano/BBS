<?php
    ...
    // セッションが正しくなければログインページへリダイレクト
    header("Location: ./admin.php");
    }

    if( !empty($_GET['message_id']) && empty($_POST['message_id']) ) {

     //GETでidが渡されていて、更新ボタは押してない時、上書きせず編集画面を表示。
        //投稿IDをサニタイズ → message_idに代入
     ...
     //編集内容を削除する処理。削除ボタンを押して、POSTが渡されたら実行。
        //POSTで渡されたIDをサニタイズして$message_idに代入
